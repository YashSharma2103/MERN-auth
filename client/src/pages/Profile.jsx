  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form className='flex flex-col gap-4'>
        ...
        <img src={currentUser.profilePicture} alt='profile-picture' className='w-24 h-24 rounded-full object-cover self-center cursor-pointer'/>
        ...
        <button className='bg-slate-700 rounded-lg text-white p-3 uppercase disabled:opacity-80 hover:opacity-95'>Update</button>
      </form>
      <div>
